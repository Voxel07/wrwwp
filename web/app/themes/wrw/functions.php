...
function airsoft_theme_enqueue_styles() {
    ...
    if (file_exists($dist_path . '/assets/vendor.js')) {
        wp_enqueue_script('wrw-react-vendor', $dist_url . '/assets/vendor.js', array(), null, true);
    }
    
    if (file_exists($dist_path . '/assets/main.js')) {
        wp_enqueue_script('wrw-react-app', $dist_url . '/assets/main.js', array('wrw-react-vendor'), null, true);
        // If there's a CSS file generated by Vite
        if (file_exists($dist_path . '/assets/main.css')) {
            wp_enqueue_style('wrw-react-style', $dist_url . '/assets/main.css');
        }
    }
}
...
add_filter('script_loader_tag', function($tag, $handle, $src) {
    if (in_array($handle, array('wrw-react-app', 'wrw-react-vendor'))) {
...
function wrw_setup_pages() {
    if (get_option('wrw_pages_created') !== 'rewrite7') {
        $pages = array(
            ...
            'community' => array('title' => 'Forum', 'template' => 'page-community.php'),
        );
